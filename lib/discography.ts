export const ALBUM_COLORS: Record<string, string> = {
  ...
  "$ome $exy $ongs 4 U": "#9B4068",
  "Iceman": "#4A9BB8",
  "Habibti": "#B85A7A",
  "Maid of Honour": "#7A5A9B",
};
...
export const DRAKE_DISCOGRAPHY: AlbumEntry[] = [
  ...
  { album: "$ome $exy $ongs 4 U", year: 2025, songs: ["CN Tower", "Moth Balls", "Something About You", "Crying in Chanel", "Spider-Man Superman", "Deeper", "Small Town Fame", "Pimmie's Dilemma", "Brian Steel", "Gimme a Hug", "Raining in Houston", "Lasers", "Meet Your Padre", "Nokia", "Die Trying", "Somebody Loves Me", "Celibacy", "OMW", "Glorious", "When He's Gone", "Greedy"] },
  ...
  { album: "Habibti", year: 2026, songs: ["Rusty Intro", "WNBA", "Slap the City", "High Fives", "Hurrr Nor Thurrr", "I'm Spent", "Classic", "Gen 5", "White Bone", "Fortworth", "Prioritizing"] },
  { album: "Maid of Honour", year: 2026, songs: ["Hoe Phase", "Road Trips", "Outside Tweaking", "Cheetah Print", "Which One", "Amazing Shape", "BBW", "True Bestie", "Where's Your Stuff Interlude", "New Bestie", "Q&A", "Stuck", "Goose and the Juice", "Princess"] },
];
